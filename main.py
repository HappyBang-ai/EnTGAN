...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='EVCI', help='path of the dataset')
...
parser.add_argument('--sample_dir', dest='sample_dir', default='./check/EVCI/sample', help='sample are saved here')
parser.add_argument('--test_dir', dest='test_dir', default='./check/EVCI/test', help='test sample are saved here')
